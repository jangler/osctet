...
fn default_keys() -> Vec<(Hotkey, Action)> {
    vec![
        ...
        (Hotkey::new(Modifiers::Shift, KeyCode::Key9), Action::IncrementOctave),
        (Hotkey::new(Modifiers::Shift, KeyCode::Key0), Action::DecrementOctave),
        ...
        (Hotkey::new(Modifiers::None, KeyCode::F8), Action::NudgeArrowUp),
        (Hotkey::new(Modifiers::None, KeyCode::F7), Action::NudgeArrowDown),
        (Hotkey::new(Modifiers::None, KeyCode::F6), Action::NudgeSharp),
        (Hotkey::new(Modifiers::None, KeyCode::F5), Action::NudgeFlat),
        ...
        (Hotkey::new(Modifiers::None, KeyCode::Minus), Action::Interpolate),
